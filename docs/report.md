...
[← README](../README.md) · [LEARNING.md](../LEARNING.md) · [docs/](README.md)
...
[`docs/research/`](research/) holds the fuller annotated library, including
[`04-novelty-verification-verdicts.md`](research/04-novelty-verification-verdicts.md) — three
agents tasked with *refuting* this project's novelty claims. Their verdict: the Phase-1 core is
well-trodden, which is the desired property for a project whose goal is learning against
